...
long getProduct(int digits) {
    long productRight = 1, productDown = 1, productDiagonalRight = 1, productDiagonalLeft = 1;
    long largest = 1;
    int numbers[20];
    int numbersLength = 0;
    ...
    for(int i = 0; i < 20; i++) {
        for(int j = 0; j < 20; j++) {
            productRight = 1;
            productDown = 1;
            productDiagonalRight = 1;
            productDiagonalLeft = 1;
            numbersLength = 0;
            
            // Right
            for(int k = j, m = 0; k < digits + j && k < 20; k++, m++) {
                if(arr[i][k] == 0) {
                    productRight = 1;
                    numbersLength = 0;
                    break;
                }
                productRight *= arr[i][k];
                numbers[m] = arr[i][k];
                numbersLength++;
            ...
            // Down
            for(int k = i, m = 0; k < digits + i && k < 20; k++, m++) {
                if(arr[k][j] == 0) {
                    productDown = 1;
                    numbersLength = 0;
                    break;
            ...
            // Diagonal Right
            for(int k = i, n = j, m = 0; k < digits + i && k < 20 && n < digits + j && n < 20; k++, m++, n++) {
                if(arr[k][n] == 0) {
                    productDiagonalRight = 1;
                    numbersLength = 0;
                    break;
                }
                productDiagonalRight *= arr[k][n];
                numbers[m] = arr[k][n];
                numbersLength++;
            ...
            // Diagonal Left
            for(int k = i, n = j, m = 0; k < digits + i && k < 20 && n > 0; k++, m++, n--) {
                if(arr[k][n] == 0) {
                    productDiagonalLeft = 1;
                    numbersLength = 0;
                    break;
                }
                productDiagonalLeft *= arr[k][n];
                numbers[m] = arr[k][n];
                numbersLength++;
